...
if(isset($_POST['addsubmit']))
{
	...
	{
		$add = new db();
		$add ->create('formateur',array($_POST['nom'],$_POST['prenom'],$_POST['accent'],$_POST['particularite'],$_POST['email'],$_POST['identifiant'],$_POST['mot_de_passe']),'nom,prenom,accent,particularite,email,identifiant,mot_de_passe');
...
<head>
  ...
  <title>Ajouter un/une formateur | Resaplanning</title>
...
<body class="not-front">
  ...
  <div id="container">
	...
	?>
	<h2 class='hf'>Ajouter un/une formateur</h2>
	<form method='post'>
	<table class='format_tbl'>
	<tr><td>Pr&eacute;nom</td><td><input type='text' name='prenom'/></td></tr>
	<tr><td>Nom</td><td><input type='text' name='nom'/></td></tr>
	<tr><td>Accent</td><td><input type='text' name='accent'/></td></tr>
	<tr><td>Particularit&eacute;</td><td><input type='text' name='particularite'/></td></tr>
	...
	<tr><td></td><td><input type='submit' name='addsubmit' value='Sauvegarder'/></td></tr>
	</table>
	</form>
